      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        ...
        {selectedPost ? (
          ...
          <div className="space-y-12">
            ...
            {loading ? (
              <div className="col-span-full rounded-2xl border border-slate-100 bg-slate-50 p-12 text-center">
                <p className="text-sm font-semibold text-slate-600">Loading blog posts...</p>
              </div>
            ) : error ? (
              <div className="col-span-full rounded-2xl border border-red-100 bg-red-50 p-12 text-center">
                <p className="text-sm font-semibold text-red-700">Unable to load blogs</p>
                <p className="mt-1 text-xs text-red-600">{error}</p>
              </div>
            ) : filteredPosts.length === 0 ? (
              <div className="col-span-full rounded-2xl border border-slate-100 bg-slate-50 p-12 text-center">
                <p className="text-sm font-semibold text-slate-600">No blog posts published yet.</p>
              </div>
            ) : (
