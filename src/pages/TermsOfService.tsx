    ...
    <div className="pb-20">
      ...
      <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-8">
        <div className="rounded-3xl border border-slate-100 bg-white p-8 sm:p-12 shadow-sm space-y-10">
          ...
          <Section title="Recruitment Disclaimer">
          ...
          <Section title="Privacy & Changes of Terms">
            ...
            <p className="mt-4">IVA Work Solutions reserves the right to modify, update, or replace these Terms and Conditions at any time. Changes will be effective upon posting on this page with an updated effective date. Continued use of our services after such changes constitutes your acceptance of the revised Terms.</p>
          </Section>
